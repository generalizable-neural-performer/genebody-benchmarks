...
class Projector():
    ...
    def compute(self,  xyz, query_camera, train_imgs, train_cameras, featmaps, ori_pts=None):
        '''
        ...
        if ori_pts is not None:
            pixel_locations, mask_in_front = self.compute_projections(ori_pts, train_cameras)
        else:
            pixel_locations, mask_in_front = self.compute_projections(xyz, train_cameras)
