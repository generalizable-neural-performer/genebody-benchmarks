...
class SingleLayerTexture(nn.Module):
    def __init__(self, W, H):
        ...
        self.layer1 = nn.Parameter(torch.zeros(1, 1, W, H, dtype=torch.float32))
...
class LaplacianPyramid(nn.Module):
    def __init__(self, W, H):
        ...
        self.layer1 = nn.Parameter(torch.zeros(1, 1, W, H, dtype=torch.float32))
        self.layer2 = nn.Parameter(torch.zeros(1, 1, W // 2, H // 2, dtype=torch.float32))
        self.layer3 = nn.Parameter(torch.zeros(1, 1, W // 4, H // 4, dtype=torch.float32))
        self.layer4 = nn.Parameter(torch.zeros(1, 1, W // 8, H // 8, dtype=torch.float32))
