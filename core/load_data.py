...
from .load_genebody import GenebodyDataset
from .utils.skeleton_utils import SMPLXSkeleton, rotate_y, rotate_x, rotate_z
...
DATASET_CATALOG = {
    ...
    'zju': {k: f'data/zju_mocap/{k}_train.h5' for k in ['315', '377', '386', '387', '390', '392', '393',
                                                             '394']
    },
    'genebody': {k: f'data/genebody/{k}_train.h5' for k in ['zhuna', 'abror', 'amaris', 'arslan', 'dannier', 'fuzhizhi2', 'huajiangtao5',
...
def get_dataset_from_catalog(args, N_samples, dataset_type, subject=None, N_nms=0):
    ...
    elif dataset_type == 'genebody':
        dataset = GenebodyDataset(path, **shared_kwargs)
    else:
