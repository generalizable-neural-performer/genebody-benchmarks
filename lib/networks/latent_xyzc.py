...
class Network(nn.Module):
    ...
    def encode_sparse_voxels(self, sp_input):
        ...
        code = self.c(torch.arange(0, 10475).to(coord.device))
        xyzc = spconv.SparseConvTensor(code, coord, out_sh, batch_size) # https://github.com/traveller59/spconv/issues/216
    ...
    def forward(self, sp_input, grid_coords, viewdir, light_pts):
        ...
        code = self.c(torch.arange(0, 10475).to(p_features.device))
