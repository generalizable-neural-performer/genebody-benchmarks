...
import torchvision
from .genebody import GeneBodyDataset

class GeneBodyTotalDataset(torch.utils.data.Dataset):

    def __init__(self, cfg, transforms, is_train = True):
        super(GeneBodyTotalDataset, self).__init__()
